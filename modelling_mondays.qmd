...
# for some reason the superimposition does not work. Use the plot below to see
...
```{r}
# run the logistic regression in R
logistic_model <-glm(Height_dich ~ Weight, data = df_hse_wk7, family = binomial)
...
#### More on the interpretation of the output of a logistic regression.
